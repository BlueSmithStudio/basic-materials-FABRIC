...
public class CrystalClusterBlock extends RawCrystalBlock implements Waterloggable {
    ...
    public CrystalClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
