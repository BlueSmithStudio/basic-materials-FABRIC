...
public class BuddingEmeraldBlock extends RawCrystalBlock {
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (random.nextInt(5) == 0) {
            ...
            } else if (blockState.isOf(ModBlocks.SMALL_EMERALD_BUD) && blockState.get(CrystalClusterBlock.FACING) == direction) {
                block = ModBlocks.MEDIUM_EMERALD_BUD;
            } else if (blockState.isOf(ModBlocks.MEDIUM_EMERALD_BUD) && blockState.get(CrystalClusterBlock.FACING) == direction) {
                block = ModBlocks.LARGE_EMERALD_BUD;
            } else if (blockState.isOf(ModBlocks.LARGE_EMERALD_BUD) && blockState.get(CrystalClusterBlock.FACING) == direction) {
